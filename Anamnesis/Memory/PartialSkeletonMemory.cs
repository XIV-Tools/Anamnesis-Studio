...
public class PartialSkeletonMemory : MemoryBase
{
	...
	[Bind(0x140, BindFlags.Pointer)] public HkaPoseMemory? Pose0 { get; set; }
	[Bind(0x148, BindFlags.Pointer)] public HkaPoseMemory? Pose1 { get; set; }
	[Bind(0x150, BindFlags.Pointer)] public HkaPoseMemory? Pose2 { get; set; }
	[Bind(0x158, BindFlags.Pointer)] public HkaPoseMemory? Pose3 { get; set; }
