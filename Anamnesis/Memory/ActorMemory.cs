...
public class ActorMemory : ActorBasicMemory
{
	...
	[Bind(0x00B4)] public float Scale { get => this.GetValue<float>(); set => this.SetValue(value); }
	[Bind(0x00F0, BindFlags.Pointer)] public ActorModelMemory? ModelObject { get => this.GetValue<ActorModelMemory?>(); set => this.SetValue(value); }
	...
	[Bind(0x09C0)] public AnimationMemory? Animation { get => this.GetValue<AnimationMemory?>(); set => this.SetValue(value); }
	[Bind(0x11F4)] public bool IsMotionEnabled { get => this.GetValue<bool>(); set => this.SetValue(value); }
	[Bind(0x19F8)] public float Transparency { get => this.GetValue<float>(); set => this.SetValue(value); }
	[Bind(0x1AD2)] public byte Voice { get => this.GetValue<byte>(); set => this.SetValue(value); }
	[Bind(0x1AD4)] public byte CharacterModeRaw { get => this.GetValue<byte>(); set => this.SetValue(value); }
	[Bind(0x1AD5)] public byte CharacterModeInput { get => this.GetValue<byte>(); set => this.SetValue(value); }
	[Bind(0x1B04)] public byte AttachmentPoint { get => this.GetValue<byte>(); set => this.SetValue(value); }
